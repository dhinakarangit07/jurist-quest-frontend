...
const WelcomeMessage = ({ teamData }: WelcomeMessageProps) => {
  ...
  return (
    <Card className={`bg-gradient-to-r from-green-500 to-blue-500 text-white border-0 transition-all duration-1000 ${
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-yellow-200 text-lg animate-pulse">
                  {teamData.teamCode}
                </span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/90">
                  {teamData.participants.length} participants
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3">
              <p className="text-2xl font-bold text-yellow-200">7 Days</p>
