  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          <div className="relative animate-bounce">
            ...
            <Gavel className="w-8 h-8 text-amber-300 absolute -top-2 -right-2 drop-shadow-lg animate-spin" style={{ animationDuration: '3s' }} />
          </div>
        </div>

        {/* Title */}
        <h1 className="text-5xl font-bold text-white mb-3 font-serif drop-shadow-lg animate-fade-in">
          Moot Court
        </h1>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-32 text-blue-400/20 animate-float delay-1000">
          <Gavel className="w-6 h-6" />
        </div>
        <div className="absolute bottom-32 left-32 text-amber-400/20 animate-float delay-500">
          <Scale className="w-10 h-10" />
        </div>
        <div className="absolute bottom-20 right-20 text-blue-400/20 animate-float delay-1500">
